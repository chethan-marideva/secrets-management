...
- `Authentication:ApiKey` - API key required for requests (sent as `X-Api-Key`). Prefer environment variables or a secure configuration provider. In development, a random key is generated if omitted.
